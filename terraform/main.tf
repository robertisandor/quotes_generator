    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Principal": {
                "Federated": "arn:aws:iam::487577641151:oidc-provider/token.actions.githubusercontent.com"
            },
            ...
            "Condition": {
                ...
                "StringLike": {
                    "token.actions.githubusercontent.com:sub": "repo:robertisandor/quotes_generator:*"
                }
            }
        }
    ]
